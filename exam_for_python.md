...
```
### Ответ: xwyz
> Пояснение: первая строка это [1 1 0 1] для #0, вторая имеет два ноля и единицы, этому подходит 0101, 0110, 1100, но во всех столбцах есть нули, значит у нас не может быть три единицы, значит вторая строка [0 1 1 0], а третья [0 0 0 1]. первый столбец занимает `X`, второй `W`, третий и четвертый
